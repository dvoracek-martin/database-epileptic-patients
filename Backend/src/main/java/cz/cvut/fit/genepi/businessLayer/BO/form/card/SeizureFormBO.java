...
public class SeizureFormBO {
    ...
    private List<SeizureDetailFormBO> seizureDetailList;
    ...
    public List<SeizureDetailFormBO> getSeizureDetailList() {
        return seizureDetailList;
    }

    public void setSeizureDetailList(List<SeizureDetailFormBO> seizureDetailList) {
