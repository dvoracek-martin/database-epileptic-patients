...
public interface DiagnosticTestScalpEegService
        extends GenericCardService<DiagnosticTestScalpEegDisplayVO, DiagnosticTestScalpEegVO, DiagnosticTestScalpEegEntity> {
