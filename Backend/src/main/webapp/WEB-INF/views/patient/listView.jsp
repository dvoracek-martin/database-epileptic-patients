    ...
    <div id="paginator" class="text-center">
        <ul class="pagination">
            ...
            <c:if test="${pageNumber-2>0}">
                <li>
                    <a href="<c:url value="/patient/list?maxResults=${maxResults}&pageNumber=${pageNumber-2}" />">${pageNumber-2}
                        <span class="sr-only"></span></a></li>
            </c:if>

            <c:if test="${pageNumber-1>0}">
                <li>
                    <a href="<c:url value="/patient/list?maxResults=${maxResults}&pageNumber=${pageNumber-1}" />">${pageNumber-1}
                        <span class="sr-only"></span></a></li>
            </c:if>
            ...
            <c:forEach var="i" begin="1" end="2">
                <c:if test="${countOfPages>=pageNumber+i}">
                    <li>
                        <a href="<c:url value="/patient/list?maxResults=${maxResults}&pageNumber=${pageNumber+i}" />">${pageNumber+i}
                            <span class="sr-only"></span></a></li>
                </c:if>
            </c:forEach>
    ...
    <div id="defaultPaginator" class="text-center" style="display: none">
        ...
        <ul class="pagination">
            ...
            <c:if test="${defaultPageNmuber-2>0}">
                <li>
                    <a href="<c:url value="/patient/list?maxResults=${maxResults}&pageNumber=${defaultPageNmuber-2}" />">${defaultPageNmuber-2}
                        <span class="sr-only"></span></a></li>
            </c:if>

            <c:if test="${defaultPageNmuber-1>0}">
                <li>
                    <a href="<c:url value="/patient/list?maxResults=${maxResults}&pageNumber=${defaultPageNmuber-1}" />">${defaultPageNmuber-1}
                        <span class="sr-only"></span></a></li>
            </c:if>
            ...
            <c:forEach var="i" begin="1" end="2">
                <c:if test="${countOfPages>=defaultPageNmuber+i}">
                    <li>
                        <a href="<c:url value="/patient/list?maxResults=${maxResults}&pageNumber=${defaultPageNmuber+i}" />">${defaultPageNmuber+i}
                            <span class="sr-only"></span></a></li>
                </c:if>
            </c:forEach>
