	...
	<jsp:body>
			<div>
				...
				<div>
					<h3 class="pull-right">
						<a id="export"
					href="<c:url value="/patient/${patient.id}/invasiveTestCorticalMapping/create" />"><spring:message code="label.addRecord"/></a>
					</h3>
				</div>
			</div>
			<table class="table">
					...
					<c:if test="${invasiveTestCorticalMapping.status==0}">
						...
						<div>
							<div class="accordion-heading">
						    	<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse${invasiveTestCorticalMapping.id}">
						    	    <strong><spring:message code="label.dateOfContractAward"/>:</strong> ${invasiveTestCorticalMapping.date}
						    	</a>
							</div>
						      	...
						      	<div class="accordion-inner">
							      	<div class="label-info" style="border-radius: 5px; padding-top: 5px; padding-left: 5px; padding-right: 5px">
										<div class="pull-right">
											<a class="close" href="<c:url value="/patient/${patientID}/invasiveTestCorticalMapping/${invasiveTestCorticalMapping.id}/hide"/>"><spring:message code="label.delete"/></a>
										</div>
										<div class="pull-left">
											<a class="close" href="<c:url value="/patient/${patientID}/invasiveTestCorticalMapping/list"/>"><spring:message code="label.edit"/></a>
										</div>
										</br>
									</div>
									<table class="table">
