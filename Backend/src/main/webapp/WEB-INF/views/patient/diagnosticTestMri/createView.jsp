...
<div class="control-group">
    <label class="control-label" for="mriDescription"><strong><spring:message
...
<div class="control-group">
    <label class="control-label" for="descriptionPetHypometabolism"><strong><spring:message
            code="label.descriptionPetHypometabolism"/></strong></label>
...
<div class="control-group">
    <label class="control-label" for="descriptionSpectHypoperfuse"><strong><spring:message
            code="label.descriptionSPECTHypoperfuse"/></strong></label>
...
<div class="control-group">
    <label class="control-label" for="descriptionSpectHyperperfuse"><strong><strong><spring:message
            code="label.descriptionSPECTHyperperfuse"/></strong></label>
...
<div class="control-group">
    <label class="control-label" for="descriptionMrsAbnormality"><strong><spring:message
            code="label.descriptionMrsAbnormality"/></strong></label>
