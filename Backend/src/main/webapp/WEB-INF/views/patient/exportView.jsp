...
<div>
    <h2>
        <spring:message code="label.exportPatient"/> <a
            href="<c:url value="/patient/${patient.id}/overview" />"            style="text-decoration: none">${patient.contact.firstName} ${patient.contact.lastName}</a>
    </h2>
</div>
<!-- Lists -->
<!-- user Lists -->
...
<li><form:label path="complicationComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="complicationComment" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestEEGDone"> <spring:message code="label.export"/></form:label> <form:checkbox path="diagnosticTestEEGDone" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestEEGSlow"> <spring:message code="label.export"/></form:label> <form:checkbox path="diagnosticTestEEGSlow" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestEEGLocalizationInerictalEEGSpikes"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="diagnosticTestEEGLocalizationInerictalEEGSpikes" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestMRIDone"> <spring:message code="label.export"/></form:label> <form:checkbox path="diagnosticTestMRIDone" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestMRIFdgPet"> <spring:message code="label.export"/></form:label> <form:checkbox path="diagnosticTestMRIFdgPet" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestMRISiscom"> <spring:message code="label.export"/></form:label> <form:checkbox path="diagnosticTestMRISiscom" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestMRIDti"> <spring:message code="label.export"/></form:label> <form:checkbox path="diagnosticTestMRIDti" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestMRIFmri"> <spring:message code="label.export"/></form:label> <form:checkbox path="diagnosticTestMRIFmri" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestMRIWada"> <spring:message code="label.export"/></form:label> <form:checkbox path="diagnosticTestMRIWada" class="input-block-level"/></li>
...
<li><form:label path="diagnosticTestMRILocalizationPetHypometabolism"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="diagnosticTestMRILocalizationPetHypometabolism" class="input-block-level"/></li>
...
<li><form:label path="histologyHistopathology"> <spring:message code="label.export"/></form:label> <form:checkbox path="histologyHistopathology" class="input-block-level"/></li>
...
<li><form:label path="histologyComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="histologyComment" class="input-block-level"/></li>


<li><form:label path="invasiveTestECOGDone"> <spring:message code="label.export"/></form:label> <form:checkbox path="invasiveTestECOGDone" class="input-block-level"/></li>
...
<li><form:label path="invasiveTestECOGComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="invasiveTestECOGComment" class="input-block-level"/></li>

<li><form:label path="invasiveTestEEGDone"> <spring:message code="label.export"/></form:label> <form:checkbox path="invasiveTestEEGDone" class="input-block-level"/></li>
...
<li><form:label path="invasiveTestEEGLocalizationIntracranialElectrodes"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="invasiveTestEEGLocalizationIntracranialElectrodes" class="input-block-level"/></li>
...
<li><form:label path="invasiveTestEEGLocalizationInvasiveEEGInterictalSpikes"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="invasiveTestEEGLocalizationInvasiveEEGInterictalSpikes" class="input-block-level"/></li>
...
<li><form:label path="invasiveTestEEGComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="invasiveTestEEGComment" class="input-block-level"/></li>
...
<li><form:label path="neurologicalFindingAbnormalNeurologicalFinding"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neurologicalFindingAbnormalNeurologicalFinding" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyNeurodevelopmentalExaminationAdaptability"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeurodevelopmentalExaminationAdaptability" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeurodevelopmentalExaminationSpeechExpressively"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeurodevelopmentalExaminationSpeechExpressively" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeurodevelopmentalExaminationSpeechReceptively"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeurodevelopmentalExaminationSpeechReceptively" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeurodevelopmentalExaminationFineMotorSkills"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeurodevelopmentalExaminationFineMotorSkills" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeurodevelopmentalExaminationGrossMotorSkills"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeurodevelopmentalExaminationGrossMotorSkills" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyIntellectualPerformanceVerbally"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyIntellectualPerformanceVerbally" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyIntellectualPerformanceNonverbalDesignCap"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyIntellectualPerformanceNonverbalDesignCap" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyNeuropsychologicalProfileAttention"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfileAttention" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyNeuropsychologicalProfileCognitiveSpeed"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfileCognitiveSpeed" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyNeuropsychologicalProfileSpeechUnderstanding"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfileSpeechUnderstanding" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeuropsychologicalProfileMemoryOperating"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfileMemoryOperating" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeuropsychologicalProfileMemoryVerbal"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfileMemoryVerbal" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeuropsychologicalProfileMemoryNonverbal"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfileMemoryNonverbal" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeuropsychologicalProfileMemoryLearning"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfileMemoryLearning" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeuropsychologicalProfilePerceptionSpeech"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfilePerceptionSpeech" class="input-block-level"/></li>
<li><form:label path="neuropsychologyNeuropsychologicalProfilePerceptionVisual"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfilePerceptionVisual" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyNeuropsychologicalProfileMotorSkillsDexterity"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyNeuropsychologicalProfileMotorSkillsDexterity" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="neuropsychologyComment" class="input-block-level"/></li>
...
<li><form:label path="operationTypeOperation"> <spring:message code="label.export"/></form:label> <form:checkbox path="operationTypeOperation" class="input-block-level"/></li>
<li><form:label path="operationRangeOperation"> <spring:message code="label.export"/></form:label> <form:checkbox path="operationRangeOperation" class="input-block-level"/></li>
...
<li><form:label path="operationMst"> <spring:message code="label.export"/></form:label> <form:checkbox path="operationMst" class="input-block-level"/></li>
<li><form:label path="operationColostomy"> <spring:message code="label.export"/></form:label> <form:checkbox path="operationColostomy" class="input-block-level"/></li>
<li><form:label path="operationVNS"> <spring:message code="label.export"/></form:label> <form:checkbox path="operationVNS" class="input-block-level"/></li>
...
<li><form:label path="operationComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="operationComment" class="input-block-level"/></li>
<li><form:label path="outcomeDate"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeDate" class="input-block-level"/></li>
<li><form:label path="outcomeAdded"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeAdded" class="input-block-level"/></li>
<li><form:label path="outcomeFinallySeizures"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeFinallySeizures" class="input-block-level"/></li>

<li><form:label path="outcomeEEG"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeEEG" class="input-block-level"/></li>
<li><form:label path="outcomeAED"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeAED" class="input-block-level"/></li>
<li><form:label path="outcomeMRI"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeMRI" class="input-block-level"/></li>
<li><form:label path="outcomeNeuropsychology"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeNeuropsychology" class="input-block-level"/></li>
<li><form:label path="outcomeComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeComment" class="input-block-level"/></li>

<li><form:label path="outcomeSeizureOutcome"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeSeizureOutcome" class="input-block-level"/></li>
<li><form:label path="outcomeDistance"> <spring:message code="label.export"/></form:label> <form:checkbox path="outcomeDistance" class="input-block-level"/></li>


<li><form:label path="pharmacotherapyAED"> <spring:message code="label.export"/></form:label> <form:checkbox path="pharmacotherapyAED" class="input-block-level"/></li>
...
<li><form:label path="pharmacotherapyComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="pharmacotherapyComment" class="input-block-level"/></li>

<li><form:label path="seizureFrequency"> <spring:message code="label.export"/></form:label> <form:checkbox path="seizureFrequency" class="input-block-level"/></li>
<li><form:label path="seizureSecondarilyGeneralizedSeizure"> <spring:message code="label.export"/></form:label>
    <form:checkbox path="seizureSecondarilyGeneralizedSeizure" class="input-block-level"/></li>
<li><form:label path="seizureStatusEpilepticus"> <spring:message code="label.export"/></form:label> <form:checkbox
        path="seizureStatusEpilepticus" class="input-block-level"/></li>
<li><form:label path="seizureSSCClassification"> <spring:message code="label.export"/></form:label> <form:checkbox
        path="seizureSSCClassification" class="input-block-level"/></li>
<li><form:label path="seizureILAEClassification"> <spring:message code="label.export"/></form:label> <form:checkbox
        path="seizureILAEClassification" class="input-block-level"/></li>
<li><form:label path="seizureSeizuresWhileAwakeEpi"> <spring:message code="label.export"/></form:label> <form:checkbox
        path="seizureSeizuresWhileAwakeEpi" class="input-block-level"/></li>
<li><form:label path="seizureSeizuresWhileAwakeLatent"> <spring:message code="label.export"/></form:label>
    <form:checkbox path="seizureSeizuresWhileAwakeLatent" class="input-block-level"/></li>
<li><form:label path="seizureSeizuresWhileAwakeNonEpi"> <spring:message code="label.export"/></form:label>
    <form:checkbox path="seizureSeizuresWhileAwakeNonEpi" class="input-block-level"/></li>
<li><form:label path="seizureSeizuresWhileSleepEpi"> <spring:message code="label.export"/></form:label> <form:checkbox
        path="seizureSeizuresWhileSleepEpi" class="input-block-level"/></li>
<li><form:label path="seizureSeizuresWhileSleepLatent"> <spring:message code="label.export"/></form:label>
    <form:checkbox path="seizureSeizuresWhileSleepLatent" class="input-block-level"/></li>
<li><form:label path="seizureSeizuresWhileSleepNonEpi"> <spring:message code="label.export"/></form:label>
    <form:checkbox path="seizureSeizuresWhileSleepNonEpi" class="input-block-level"/></li>
<li><form:label path="seizureComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="seizureComment" class="input-block-level"/></li>

<li><form:label path="
seizureSSCClassification"> <spring:message code="label.export"/></form:label> <form:checkbox path="seizureSSCClassification" class="input-block-level"/></li>
<li><form:label path="seizureDetailILAEClassification"> <spring:message code="label.export"/></form:label>
    <form:checkbox path="seizureDetailILAEClassification" class="input-block-level"/></li>
<li><form:label path="seizureDetailComment"> <spring:message code="label.export"/></form:label> <form:checkbox path="seizureDetailComment" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyOldNeuropsychologicalExamination"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyOldNeuropsychologicalExamination" class="input-block-level"/></li>
...
<li><form:label path="neuropsychologyOldDevelopmentalLanguageDisorders"> <spring:message
        code="label.export"/></form:label> <form:checkbox path="neuropsychologyOldDevelopmentalLanguageDisorders" class="input-block-level"/></li>
