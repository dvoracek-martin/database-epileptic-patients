...
<t:menuLVL3>
    ...
    <jsp:body>
        ...
        <form:form class="form-horizontal" method="POST"
            ...
            <div class="control-group">
                <label class="control-label" for="histopathology"><strong><spring:message
                        code="label.histopathology"/></strong></label>
            ...
            <div class="control-group">
                <label class="control-label" for="fcdClasification"><strong><spring:message
                        code="label.FCDClasification"/></strong></label>
