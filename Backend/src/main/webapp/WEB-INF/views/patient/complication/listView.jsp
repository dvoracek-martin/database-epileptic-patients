    ...
    <jsp:body>
        <div>
            ...
            <div>
                <h3 class="pull-right">
                    <a id="export"
                       href="<c:url value="/patient/${patientID}/complication/create" />"><spring:message
                    ...
                    <div>
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse"
                               data-parent="#accordion" href="#collapse${complication.id}">
                                <strong><spring:message
                                        code="label.dateOfContractAward"/>:</strong> ${complication.date}
                            </a>
                        </div>

                        <div id="collapse${complication.id}"
                            ...
                            <div class="accordion-inner">
                                <div class="label-info"
                                    ...
                                    <div class="pull-right">
                                        <a class="close"
                                           href="<c:url value="/patient/${patientID}/complication/${complication.id}/hide"/>"><spring:message
                                                code="label.delete"/></a>
                                    </div>
                                    <div class="pull-left">
                                        <a class="close"
                                           href="<c:url value="/patient/${patientID}/complication/list"/>"><spring:message
                                                code="label.edit"/></a>
                                    </div>
                                </div>
                                <table class="table">
