...
<div class="control-group">
    <label class="control-label" for="neurodevelopmentalExaminationSpeechExpressively"><strong>Řeč
        expresivně</strong></label>

    <div class="controls">
        <form:select path="neurodevelopmentalExaminationSpeechExpressively"
                     id="neurodevelopmentalExaminationSpeechExpressively" type="text" class="input-large">
            <form:option value="0">
                -
            </form:option>
            <form:option value="1">
...
<div class="control-group">
    <label class="control-label" for="neurodevelopmentalExaminationSpeechReceptively"><strong>Řeč
        receptivně</strong></label>

    <div class="controls">
        <form:select path="neurodevelopmentalExaminationSpeechReceptively"
                     id="neurodevelopmentalExaminationSpeechReceptively" type="text" class="input-large">
            <form:option value="0">
                -
            </form:option>
            <form:option value="1">
...
<div class="control-group">
    <label class="control-label" for="neurodevelopmentalExaminationFineMotorSkills"><strong>Jemná
        motorika</strong></label>

    <div class="controls">
        <form:select path="neurodevelopmentalExaminationFineMotorSkills"
                     id="neurodevelopmentalExaminationFineMotorSkills" type="text" class="input-large">
            <form:option value="0">
                -
            </form:option>
            <form:option value="1">
...
<div class="control-group">
    <label class="control-label" for="neurodevelopmentalExaminationGrossMotorSkills"><strong>Hrubá
        motorika</strong></label>

    <div class="controls">
        <form:select path="neurodevelopmentalExaminationGrossMotorSkills"
                     id="neurodevelopmentalExaminationGrossMotorSkills" type="text" class="input-large">
            <form:option value="0">
                -
            </form:option>
            <form:option value="1">
...
<div class="control-group">
    <label class="control-label" for="neurodevelopmentalExaminationSocialBehavior"><strong>Sociální
        chování</strong></label>
...
<div class="control-group">
    <label class="control-label" for="intellectualPerformanceNonverbalAbstraction"><strong>Neverbální -
        abstrakce</strong></label>
...
<div class="control-group">
    <label class="control-label" for="intellectualPerformanceNonverbalDesignCapabilities"><strong>Neverbální -
        konstrukční schopnosti</strong></label>

    <div class="controls">
        <form:select path="intellectualPerformanceNonverbalDesignCapabilities"
                     id="intellectualPerformanceNonverbalDesignCapabilities" type="text" class="input-large">
            <form:option value="0">
                -
            </form:option>
            <form:option value="1">
...
<div class="control-group">
    <label class="control-label" for="neuropsychologicalProfile"><strong><spring:message
            code="label.neuropsychologicalProfile"/></strong></label>
