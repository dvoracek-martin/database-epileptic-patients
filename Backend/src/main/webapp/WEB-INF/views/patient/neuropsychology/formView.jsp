...
<div id="intellect-neurodevelopmental-examination">
    <jsp:include page="deficitOptionsView.jsp">
        <jsp:param name="labelName"
                   value="neurodevelopmentalExamination"/>
    ...
    <fieldset>
        ...
        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="adaptability"/>
            <jsp:param name="propertyName"
                       value="neurodevelopmentalExaminationAdaptability"/>
        </jsp:include>

        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="speechExpressively"/>
            <jsp:param name="propertyName"
                       value="neurodevelopmentalExaminationSpeechExpressively"/>
        </jsp:include>

        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="speechReceptively"/>
            <jsp:param name="propertyName"
                       value="neurodevelopmentalExaminationSpeechReceptively"/>
        </jsp:include>
        ...
        <jsp:include page="deficitOptionsView.jsp">
            ...
            <jsp:param name="propertyName"
                       value="neurodevelopmentalExaminationFineMotorSkills"/>
        </jsp:include>
        ...
        <jsp:include page="deficitOptionsView.jsp">
            ...
            <jsp:param name="propertyName"
                       value="neurodevelopmentalExaminationGrossMotorSkills"/>
        </jsp:include>
        ...
        <jsp:include page="deficitOptionsView.jsp">
            ...
            <jsp:param name="propertyName"
                       value="neurodevelopmentalExaminationSocialBehavior"/>
        </jsp:include>
    </fieldset>
    <hr>
</div>
...
<div id="intellect-intellectual-performance">
    ...
    <jsp:include page="deficitOptionsView.jsp">
        <jsp:param name="labelName"
                   value="intellectualPerformanceVerbally"/>
        <jsp:param name="propertyName"
                   value="intellectualPerformanceVerbally"/>
    </jsp:include>
    ...
    <jsp:include page="deficitOptionsView.jsp">
        <jsp:param name="labelName"
                   value="intellectualPerformanceNonverbalAbstraction"/>
        <jsp:param name="propertyName"
                   value="intellectualPerformanceNonverbalAbstraction"/>
    </jsp:include>
    ...
    <jsp:include page="deficitOptionsView.jsp">
        <jsp:param name="labelName"
                   value="intellectualPerformanceNonverbalDesignCapabilities"/>
        <jsp:param name="propertyName"
                   value="intellectualPerformanceNonverbalDesignCapabilities"/>
    </jsp:include>
...
<div class="form-group">
    <label class="col-xs-4 control-label"
           for="neuropsychologicalProfile">
        <spring:message code="label.neuropsychologicalProfile"/>
    </label>

    <div class="col-xs-8">
        <form:select id="neuropsychologicalProfile"
                     class="form-control input-sm"
                     type="text"
                     path="neuropsychologicalProfile">
            <form:option value="0">
    ...
    <fieldset>
        ...
        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="attention"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileAttention"/>
        </jsp:include>
        ...
        <jsp:include page="deficitOptionsView.jsp">
            ...
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileExecutiveFunction"/>
        </jsp:include>
        ...
        <jsp:include page="deficitOptionsView.jsp">
            ...
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileCognitiveSpeed"/>
        </jsp:include>

        <div class="form-group">
            <label class="col-xs-4 control-label"
                   for="neuropsychologicalProfileSpeechExpressively">
                <spring:message code="label.speechExpressively"/>
            </label>

            <div class="col-xs-8">
                <form:select id="neuropsychologicalProfileSpeechExpressively"
                             class="form-control input-sm"
                             type="text"
                             path="neuropsychologicalProfileSpeechExpressively">
                    <form:option value="1">
        ...
        <jsp:include page="deficitOptionsView.jsp">
            ...
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileSpeechUnderstanding"/>
        </jsp:include>

        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="memoryOperating"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileMemoryOperating"/>
        </jsp:include>
        ...
        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="memoryVerbal"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileMemoryVerbal"/>
        </jsp:include>

        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="memoryNonverbal"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileMemoryNonverbal"/>
        </jsp:include>

        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="memoryLearning"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileMemoryLearning"/>
        </jsp:include>

        <div class="form-group">
            <label class="col-xs-4 control-label"
                   for="neuropsychologicalProfilePerceptionSpeech">
                <spring:message code="label.perceptionSpeech"/>
            </label>

            <div class="col-xs-8">
                <form:select id="neuropsychologicalProfilePerceptionSpeech"
                             class="form-control input-sm"
                             type="text"
                             path="neuropsychologicalProfilePerceptionSpeech">
                    <form:option value="1">
        ...
        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="perceptionVisual"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfilePerceptionVisual"/>
        </jsp:include>

        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="perceptionSpatial"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfilePerceptionSpatial"/>
        </jsp:include>

        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="motorSkillsDexterity"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileMotorSkillsDexterity"/>
        </jsp:include>

        <jsp:include page="deficitOptionsView.jsp">
            <jsp:param name="labelName"
                       value="motorCoordination"/>
            <jsp:param name="propertyName"
                       value="neuropsychologicalProfileMotorCoordination"/>
        </jsp:include>
    </fieldset>
    <hr>
</div>
...
<div class="form-group">
    <label class="col-xs-4 control-label"
           for="presenceOfChanges">
        <spring:message code="label.presenceOfChanges"/>*
    </label>

    <div class="col-xs-8">
        <form:select id="presenceOfChanges"
                     class="form-control  input-sm"
                     type="text"
                     path="presenceOfChanges">
            <form:option value="0">
        ...
        <form:errors path="presenceOfChanges"
                     cssClass="text-danger"/>
    </div>
</div>
...
<div id="presence-of-changes-deterioration">
    <div class="form-group">
        <label class="col-xs-4 control-label"
               for="presenceOfChangesDetail">
            <spring:message code="label.presenceOfChangesDetail"/>
        </label>

        <div class="col-xs-8">
            <form:select id="presenceOfChangesDetail"
                         class="form-control input-sm"
                         type="text"
                         multiple="multiple"
                         path="presenceOfChangesDetail">
                <form:option value="1">
...
<div class="form-group">
    ...
    <div class="col-xs-8">
        <form:select id="emotionalState"
                     class="form-control input-sm"
                     type="text"
                     path="emotionalStatus">
            <form:option value="0">
        ...
        <form:errors path="emotionalStatus"
                     cssClass="text-danger"/>
    </div>
</div>
