...
<div>
    ...
    <div>
        <h3 class="pull-right">
            <a id="export"
               href="<c:url value="/patient/${patientID}/diagnosticTestScalpEEG/create"  />"><spring:message
            ...
            <div>
                <div class="accordion-heading">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                       href="#collapse${diagnosticTestEEG.id}">
                    ...
                    <div class="accordion-inner">
                        <div class="label-info"
                            ...
                            <div class="pull-right">
                                <a class="close"
                                   href="<c:url value="/patient/${patientID}/diagnosticTestScalpEEG/${diagnosticTestEEG.id}/hide"/>"><spring:message
                                        code="label.delete"/></a>
                            </div>
                            <div class="pull-left">
                                <a class="close"
                                   href="<c:url value="/patient/${patientID}/diagnosticTestScalpEEG/list"/>"><spring:message
                                        code="label.edit"/></a>
                            </div>
                            </br>
                        </div>
