...
<t:menuLVL3>
    ...
    <jsp:body>
        ...
        <div>
            ...
            <div>
                <h3 class="pull-right">
                    <a href="<c:url value="/patient/${patient.id}/invasiveTestECOG/create" />"><spring:message
                    ...
                    <div>
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                               href="#collapse${invasiveTestECOG.id}">
                                <strong><spring:message
                                        code="label.examinationDate"/>:</strong> ${invasiveTestECOG.date}
                            </a>
                        </div>
                            ...
                            <div class="accordion-inner">
                                <div class="label-info"
                                    ...
                                    <div class="pull-right">
                                        <a class="close"
                                           href="<c:url value="/patient/${patientID}/invasiveTestECOG/${invasiveTestECOG.id}/hide"/>"><spring:message
                                                code="label.delete"/></a>
                                    </div>
                                    <div class="pull-left">
                                        <a class="close"
                                           href="<c:url value="/patient/${patientID}/invasiveTestECOG/list"/>"><spring:message
                                                code="label.edit"/></a>
                                    </div>
                                    </br>
                                </div>
