...
<form:form class="form-horizontal" method="POST" action="/GENEPI/patient/create" commandName="patient">
    ...
    <div class="form-group">
        <label for="doctor" class="col-xs-3 control-label">
            <spring:message code="label.doctor"/>
        </label>

        <div class="col-xs-8">
            <select name="doctorId" class="form-control" id="ffffffffffffffffffffffff">
