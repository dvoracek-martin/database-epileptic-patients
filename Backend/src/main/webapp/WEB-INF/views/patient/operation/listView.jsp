...
<div>
    ...
    <div>
        <h3 class="pull-right">
            <a id="export"
               href="<c:url value="/patient/${patientID}/operation/create" />"><spring:message
                    ...
                    <div class="accordion-inner">
                        <div class="label-info"
                            ...
                            <div class="pull-right">
                                <a class="close"
                                   href="<c:url value="/patient/${patientID}/operation/${operation.id}/hide"/>"><spring:message
                                        code="label.delete"/></a>
                            </div>
                            <div class="pull-left">
                                <a class="close"
                                   href="<c:url value="/patient/${patientID}/operation/list"/>"><spring:message
                                        code="label.edit"/></a>
                            </div>
                            </br>
                        </div>
