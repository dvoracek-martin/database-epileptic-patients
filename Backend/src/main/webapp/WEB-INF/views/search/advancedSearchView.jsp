...
<fieldset id="diagnosticTestScalpEegFieldset">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            <form:select path="diagnosticTestScalpEegBasicEegActivity" id="basicEegActivity" type="text" class="input-sm form-control">
                <form:option value="0">
                    Zvolte
                </form:option>
                <form:option value="1">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            <form:select path="diagnosticTestScalpEegInterictalEegSpikes" id="interictalEegSpikes" type="text" class="input-sm form-control">
                <form:option value="0">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            <form:select path="diagnosticTestScalpEegIctalEegPatterns" id="ictalEegPatterns" type="text" class="input-sm form-control">
                <form:option value="0">
