		...
		<div class="span9">
			<div class="hero-unit">
				...
				<div class="form" style="margin: 10px; width: 60%">
					...
					<form:form method="POST" action="patient/${patientID}/addAnamnesis"
						...
						<form:input path="nonCnsComorbidity" type="text"
							value="porod per S.C. pro gestrózu zjistenou az behem porodu"
							class="input-block-level" />
